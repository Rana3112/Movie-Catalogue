...
3.  **Environment Variables**
    Create a `.env` file in the root and server directories with your keys:
    *   `VITE_GOOGLE_CLIENT_ID`: Google OAuth ID
    *   `VITE_OMDB_API_KEY`: Key from [omdbapi.com](https://www.omdbapi.com/apikey.aspx) (for Rotten Tomatoes scores)
