...
export default function Bend({
  ...
  useEffect(() => {
    ...
    instanceRef.current = createBend(
      ...
      { zone, angle, rounding, perspective, direction, ease, smoothing, top, bottom, tumble, tilt },
    );
  ...
  useEffect(() => {
    instanceRef.current?.setOptions({ zone, angle, rounding, perspective, direction, ease, smoothing, top, bottom, tumble, tilt });
  });
