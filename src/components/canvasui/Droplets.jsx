...
/* eslint-disable no-empty, react-hooks/set-state-in-effect, react-hooks/exhaustive-deps */
...
void main () {
  ...
  function render(timeSec) {
    ...
    gl.uniform2f(uniforms.uOffset, content.scrollLeft / Math.max(content.clientWidth, 1), -content.scrollTop / Math.max(content.clientHeight, 1));
...
export default function Droplets({
  ...
  useEffect(() => {
    ...
    instanceRef.current = createDroplets(
      ...
      { intensity, speed, scale, dropWidth, dropLength, refraction, blur, vignette, fallSpeed, wiggle, staticDrops, interactive, interactionRadius, interactionStrength, interactionDistortion, tint, tintStrength },
    );
  ...
  useEffect(() => {
    instanceRef.current?.setOptions({ intensity, speed, scale, dropWidth, dropLength, refraction, blur, vignette, fallSpeed, wiggle, staticDrops, interactive, interactionRadius, interactionStrength, interactionDistortion, tint, tintStrength });
  });
